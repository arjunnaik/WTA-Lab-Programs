...
<body>
    ...
    <form action="Program8a.php" method="post">
        <table>
            <tr>
                <td>Enter First Number: </td>
                <td><input type="text" name="first" required autocomplete="off" /></td>
            </tr>
            <tr>
                <td>Enter Second Number: </td>
                <td><input type="text" name="second" required autocomplete="off" /></td>
            </tr>
            <tr>
    ...
    if (isset($_POST['pop'])) {
        ...
        switch ($op) {
            ...
            case '/':
                ...
                echo "<h1>Division of 2 Numbers: " . $result .
                    "</h1>";
                break;
            case '%':
                $result = $num1 % $num2;
